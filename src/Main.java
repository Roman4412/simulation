...
public class Main {
    ...
    private static final int INIT_HERBIVORES_AMOUNT = 10;
    private static final int INIT_PREDATORS_AMOUNT = 2;
    private static final int INIT_GRASS_AMOUNT = 30;
    private static final int INIT_TREES_AMOUNT = 30;
    ...
    private static final int MIN_LIMIT_HERBIVORES = 3;
    private static final int GENERATED_GRASS_AMOUNT_PER_TURN = 20;
